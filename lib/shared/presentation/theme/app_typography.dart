...
class AppTypography {
  ...
  // Button text styles
  static TextStyle get buttonLarge => bodyLG.copyWith(
        fontWeight: FontWeight.w600,
        color: Colors.white,
      );

  static TextStyle get buttonMedium => body.copyWith(
        fontWeight: FontWeight.w600,
        color: Colors.white,
      );
  ...
  static TextStyle get errorText => body.copyWith(
        color: AppColors.appleRed,
        fontWeight: FontWeight.w500,
      );

  static TextStyle get successText => body.copyWith(
  ...
  // Input text styles
  static TextStyle get inputText => body.copyWith(
        color: AppColors.soilCharcoal,
      );

  static TextStyle get inputHint => body.copyWith(
        color: AppColors.soilTaupe,
      );
  ...
  static TextTheme get textTheme => TextTheme(
        ...
        headlineSmall: h2,
        titleLarge: h2,
        titleMedium: h2.copyWith(fontSize: 20, height: 26 / 20, fontWeight: FontWeight.w600),
        titleSmall: h2.copyWith(fontSize: 18, height: 24 / 18, fontWeight: FontWeight.w600),
        bodyLarge: bodyLG,
        bodyMedium: body,
  ...
  static TextStyle get cardTitle => h2.copyWith(
        color: AppColors.soilCharcoal,
        fontWeight: FontWeight.w600,
      );

  static TextStyle get cardSubtitle => body.copyWith(
        color: AppColors.soilTaupe,
        fontWeight: FontWeight.w400,
      );
