  ...
  group('Story vs Feed Posting Bug Fix Tests', () {
    ...
    test('Bug scenario: HiveService should pass isStory to quarantined items', () {
      ...
      final quarantinedItem = PendingMediaItem(
        ...
        isStory: originalStoryItem.isStory, // THE FIX: This field must be preserved!
      );
      
      // Verify the fix preserves isStory
      expect(quarantinedItem.isStory, equals(originalStoryItem.isStory),
        reason: 'Quarantined item must preserve original isStory value');
      expect(quarantinedItem.isStory, isTrue,
    ...
    test('toString() method includes isStory field for debugging', () {
      ...
      expect(storyString, contains('isStory: true'),
