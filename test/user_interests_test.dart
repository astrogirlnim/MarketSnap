...
void main() {
  group('UserInterests Model Unit Tests', () {
    ...
    test('should update interests with positive feedback correctly', () {
      ...
      expect(
        updatedInterests.categoryRelevanceScores['vegetables'],
        equals(0.8),
      );
    ...
    test('should calculate personalization confidence correctly', () {
      ...
      expect(
        interests.satisfactionScore,
        greaterThan(0.6),
      ); // Should be positive overall

      debugPrint('✅ Personalization confidence calculation test passed');
      debugPrint(
        '   Confidence: ${interests.personalizationConfidence.toStringAsFixed(2)}',
      );
      debugPrint(
        '   Satisfaction: ${interests.satisfactionScore.toStringAsFixed(2)}',
      );
    });
    ...
    test('should maintain keyword limits', () {
      ...
      debugPrint(
        '✅ Keyword limits maintained: ${interests.preferredKeywords.length} keywords',
      );
    });
    ...
    test('should maintain category limits', () {
      ...
      debugPrint(
        '✅ Category limits maintained: ${interests.preferredCategories.length} categories',
      );
    });
    ...
    test('should maintain search terms limits', () {
      ...
      debugPrint(
        '✅ Search terms limits maintained: ${interests.recentSearchTerms.length} terms',
      );
    });
    ...
    test('should maintain vendor limits', () {
      ...
      debugPrint(
        '✅ Vendor limits maintained: ${interests.favoriteVendors.length} vendors',
      );
    });
    ...
    test('should handle mixed feedback patterns correctly', () {
      ...
      debugPrint(
        '   Top keywords: ${interests.preferredKeywords.take(3).join(', ')}',
      );
    });
    ...
    test('should handle performance with large datasets', () {
      ...
      debugPrint(
        '✅ Performance test: 100 interactions in ${processingTime.inMilliseconds}ms',
      );
      debugPrint(
        '   Final confidence: ${interests.personalizationConfidence.toStringAsFixed(2)}',
      );
    });
